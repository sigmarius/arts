...
/* harmony import */ var _modules_requestAnimation__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/requestAnimation */ "./src/js/modules/requestAnimation.js");
/* harmony import */ var _modules_drop__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/drop */ "./src/js/modules/drop.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_validate__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_validate__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]'); // подгрузка элементов из верстки
  ...
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_11__["default"])('.burger-menu', '.burger'); // скролинг на чистом JS
  // scrolling('.pageup');

  Object(_modules_requestAnimation__WEBPACK_IMPORTED_MODULE_13__["default"])('.pageup');
  Object(_modules_drop__WEBPACK_IMPORTED_MODULE_14__["default"])();
});
  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      if (this.classList.contains('active-style')) {
        // scrollHeight - высота контента, который содержится внутри элемента + padding (80px)
        this.nextElementSibling.style.maxHeight = this.nextElementSibling.scrollHeight + 80 + 'px';
      } else {
        this.nextElementSibling.style.maxHeight = '0px';
      }
    });
  }); // задействованы CSS-стили  
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  burgerElem.addEventListener('click', function () {
    // availWidth - ширина экрана пользователя, которая служит для вывода контента (без полосы прокрутки и т.д.)
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var sum = 0; // константа для хранения значения промокода
...
var drop = function drop() {
  ...
  ['dragenter', 'dragleave', 'dragover', 'drop'].forEach(function (evtName) {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (evt) {
      ...
      var dots; // содержит ... если имя файла больше 6 символов
      // 'abcdefjh.png' => ['abcdefjh', 'png']

      var splitArr = input.files[0].name.split('.');
      splitArr[0].length > 6 ? dots = '...' : dots = '.';
      var name = splitArr[0].substring(0, 6) + dots + splitArr[1];
...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="upload"]'); // validateInputs('input[name="user_phone"]');
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var splitArr = item.files[0].name.split('.');
      splitArr[0].length > 6 ? dots = '...' : dots = '.';
      var name = splitArr[0].substring(0, 6) + dots + splitArr[1];
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (evt) {
      ...
      var api; // формирует динамический путь для отправки на выбранный сервер в зависимости от контента
...
/***/ "./src/js/modules/loadFromServer.js":
/*!******************************************!*\
  !*** ./src/js/modules/loadFromServer.js ***!
  \******************************************/
/*! exports provided: default */
...
var loadFromServer = function loadFromServer(trigger, wrapper) {
  var btn = document.querySelector(trigger); // обращение через сервер
  // btn.addEventListener('click', function() {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('assets/db.json') // обращаемся к свойству styles в файле
    .then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = (loadFromServer);
...
var mask = function mask(selector) {
  var setCursorPosition = function setCursorPosition(position, elem) {
    elem.focus();
  ...
  function createMask(evt) {
    ...
    def = matrix.replace(/\D/g, ''),
        val = this.value.replace(/\D/g, ''); // не даст пользователю удалить штатные элементы маски +, 7 и др, заданные в matrix    
...
var modals = function modals() {
  var btnPressed; // следит, нажал ли пользователь на какую-нибудь кнопку
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  function showImg(block) {
    var img = block.querySelector('img'); // something.png => something-1.png
    // количество символов с конца, которые будем отрезать

    img.src = img.src.slice(0, -4) + '-1.png'; // скрываем все параграфы, кроме p.sizes-hit
  ...
  function hideImg(block) {
    var img = block.querySelector('img'); // something-1.png => something.png
    // количество символов с конца, которые будем отрезать

    img.src = img.src.slice(0, -6) + '.png'; // скрываем все параграфы, кроме p.sizes-hit
...
/***/ "./src/js/modules/requestAnimation.js":
/*!********************************************!*\
  !*** ./src/js/modules/requestAnimation.js ***!
  \********************************************/
/*! exports provided: default */
...
var requestAnimation = function requestAnimation(upSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (requestAnimation);
...
var sliders = function sliders(slides, direction, prev, next) {
  ...
  } catch (evt) {} // отключает автопрокрутку, когда курсор находится в зоне слайдера
...
var validateInputs = function validateInputs(selector) {
  var txtInputs = document.querySelectorAll(selector);
  txtInputs.forEach(function (item) {
